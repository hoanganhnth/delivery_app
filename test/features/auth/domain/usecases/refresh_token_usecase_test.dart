...
void main() {
  ...
  group('RefreshTokenUseCase - Domain Layer Tests', () {
    ...
    group('Input Validation', () {
      test(
        'should return ValidationFailure when refresh token is empty',
        () async {
          // Arrange
          final invalidParams = RefreshTokenParams(refreshToken: '');
    ...
    group('Business Logic Tests', () {
      test(
        'should return new AuthEntity when refresh token is valid',
        () async {
          // Arrange
          when(
          ...
          verify(
            mockRepository.refreshToken('valid_refresh_token_123'),
          ).called(1);
        },
      );
    ...
    group('Edge Cases', () {
      ...
      test('should validate token is passed correctly to repository', () async {
        ...
        expect(result.isRight(), true);
        final captured =
            verify(mockRepository.refreshToken(captureAny)).captured.single
                as String;
