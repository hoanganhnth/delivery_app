...
switch (_that) {
case _JoinLivestreamDto():
return $default(_that.livestreamId,_that.channelName,_that.title,_that.restaurantId,_that.token,_that.uid,_that.tokenExpiresAt,_that.sellerId,_that.startedAt,_that.currentViewers);}
}
