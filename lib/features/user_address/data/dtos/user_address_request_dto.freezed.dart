...
mixin _$UserAddressRequestDto {
 ...
 String get label; String get recipientName; String get phoneNumber; String get addressLine; String get ward; String get district; String get city; String? get postalCode; double? get latitude; double? get longitude; bool? get isDefault;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,label,recipientName,phoneNumber,addressLine,ward,district,city,postalCode,latitude,longitude,isDefault);

@override
String toString() {
  return 'UserAddressRequestDto(label: $label, recipientName: $recipientName, phoneNumber: $phoneNumber, addressLine: $addressLine, ward: $ward, district: $district, city: $city, postalCode: $postalCode, latitude: $latitude, longitude: $longitude, isDefault: $isDefault)';
}
...
@useResult
$Res call({
 String label, String recipientName, String phoneNumber, String addressLine, String ward, String district, String city, String? postalCode, double? latitude, double? longitude, bool? isDefault
});
...
/// Create a copy of UserAddressRequestDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? label = null,Object? recipientName = null,Object? phoneNumber = null,Object? addressLine = null,Object? ward = null,Object? district = null,Object? city = null,Object? postalCode = freezed,Object? latitude = freezed,Object? longitude = freezed,Object? isDefault = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String label,  String recipientName,  String phoneNumber,  String addressLine,  String ward,  String district,  String city,  String? postalCode,  double? latitude,  double? longitude,  bool? isDefault)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserAddressRequestDto() when $default != null:
return $default(_that.label,_that.recipientName,_that.phoneNumber,_that.addressLine,_that.ward,_that.district,_that.city,_that.postalCode,_that.latitude,_that.longitude,_that.isDefault);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String label,  String recipientName,  String phoneNumber,  String addressLine,  String ward,  String district,  String city,  String? postalCode,  double? latitude,  double? longitude,  bool? isDefault)  $default,) {final _that = this;
switch (_that) {
case _UserAddressRequestDto():
return $default(_that.label,_that.recipientName,_that.phoneNumber,_that.addressLine,_that.ward,_that.district,_that.city,_that.postalCode,_that.latitude,_that.longitude,_that.isDefault);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String label,  String recipientName,  String phoneNumber,  String addressLine,  String ward,  String district,  String city,  String? postalCode,  double? latitude,  double? longitude,  bool? isDefault)?  $default,) {final _that = this;
switch (_that) {
case _UserAddressRequestDto() when $default != null:
return $default(_that.label,_that.recipientName,_that.phoneNumber,_that.addressLine,_that.ward,_that.district,_that.city,_that.postalCode,_that.latitude,_that.longitude,_that.isDefault);case _:
  return null;
...
class _UserAddressRequestDto implements UserAddressRequestDto {
  const _UserAddressRequestDto({required this.label, required this.recipientName, required this.phoneNumber, required this.addressLine, required this.ward, required this.district, required this.city, this.postalCode, this.latitude, this.longitude, this.isDefault});
...
/// Create a copy of UserAddressRequestDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? label = null,Object? recipientName = null,Object? phoneNumber = null,Object? addressLine = null,Object? ward = null,Object? district = null,Object? city = null,Object? postalCode = freezed,Object? latitude = freezed,Object? longitude = freezed,Object? isDefault = freezed,}) {
