...
@override
String toString() {
  return 'UserModel(id: $id, authId: $authId, email: $email, role: $role, fullName: $fullName, phone: $phone, dob: $dob, avatarUrl: $avatarUrl, address: $address, createdAtString: $createdAtString, updatedAtString: $updatedAtString)';
}
...
switch (_that) {
case _UserModel():
return $default(_that.id,_that.authId,_that.email,_that.role,_that.fullName,_that.phone,_that.dob,_that.avatarUrl,_that.address,_that.createdAtString,_that.updatedAtString);}
}
...
class _UserModel implements UserModel {
  const _UserModel({this.id, required this.authId, required this.email, required this.role, this.fullName, this.phone, this.dob, this.avatarUrl, this.address, this.createdAtString, this.updatedAtString});
