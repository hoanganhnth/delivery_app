...
class ProfileRepositoryImpl implements ProfileRepository {
  ...
  Future<Either<Failure, UserEntity>> getUserProfile() async {
    try {
      ...
      return result.fold(
        (exception) {
          AppLogger.e('Repository: Failed to get user profile - $exception');
        ...
        (response) {
          if (response.isSuccess && response.data != null) {
            ...
            AppLogger.e('Repository: Get user profile failed - ${response.message}');
  ...
  Future<Either<Failure, UserEntity>> updateUserProfile(UserEntity user) async {
    try {
      ...
      return result.fold(
        (exception) {
          AppLogger.e('Repository: Failed to update user profile - $exception');
          return left(_mapExceptionToFailure(exception));
        },
        (response) {
          if (response.isSuccess && response.data != null) {
            ...
            AppLogger.e('Repository: Update user profile failed - ${response.message}');
            return left(ServerFailure(response.message));
          }
        },
      );
    } catch (e) {
      AppLogger.e('Repository: Unexpected error during update user profile - $e');
      return left(const ServerFailure('Unexpected error occurred'));
    }
  }
  ...
  Future<Either<Failure, UserEntity?>> getCachedUserProfile() async {
    try {
      ...
      return result.fold(
        (exception) {
          AppLogger.e('Repository: Failed to get cached user profile - $exception');
      ...
      AppLogger.e('Repository: Unexpected error during get cached user profile - $e');
  ...
  Future<Either<Failure, void>> cacheUserProfile(UserEntity user) async {
    try {
      ...
      AppLogger.e('Repository: Unexpected error during cache user profile - $e');
      return left(const CacheFailure('Unexpected error occurred'));
    }
  }
  ...
  Future<Either<Failure, void>> clearCachedUserProfile() async {
    try {
      ...
      return result.fold(
        (exception) {
          AppLogger.e('Repository: Failed to clear cached user profile - $exception');
      ...
      AppLogger.e('Repository: Unexpected error during clear cached user profile - $e');
      return left(const CacheFailure('Unexpected error occurred'));
    }
  }
  ...
  Future<Either<Failure, String>> uploadAvatar(String imagePath) async {
    try {
      ...
      final result = await remoteDataSource.uploadAvatar(imagePath);
      
      return result.fold(
        (exception) {
          AppLogger.e('Repository: Failed to upload avatar - $exception');
          return left(_mapExceptionToFailure(exception));
        },
        (response) {
          if (response.isSuccess && response.data != null ) {
