...
class PriceSyncResult {
  ...
  bool get hasChanges =>
      priceChanges.isNotEmpty || unavailableItemIds.isNotEmpty;
}
...
class CartNotifier extends _$CartNotifier {
    ...
    try {
      ...
      if (syncResult.hasChanges) {
        ...
        final updatedCart = CartEntity(
          items: updatedItems,
          currentRestaurantId: updatedItems.isEmpty
              ? null
              : currentCart.currentRestaurantId,
  ...
  Future<void> updateItemQuantity(num menuItemId, int quantity) async {
    ...
    final updateQuantityUseCase = ref.read(
