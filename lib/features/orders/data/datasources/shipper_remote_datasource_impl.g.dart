...
class _ShipperApiService implements ShipperApiService {
  ...
  Future<BaseResponseDto<ShipperDto>> getShipperById(int shipperId) async {
    ...
    final _options = _setStreamType<BaseResponseDto<ShipperDto>>(
    ...
    late BaseResponseDto<ShipperDto> _value;
    try {
      _value = BaseResponseDto<ShipperDto>.fromJson(
        _result.data!,
  ...
  Future<BaseResponseDto<List<ShipperDto>>> getShippersInArea(
    ...
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<BaseResponseDto<List<ShipperDto>>>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponseDto<List<ShipperDto>> _value;
    try {
  ...
  @override
  Future<BaseResponseDto<void>> updateShipperOnlineStatus(
    int shipperId,
    ...
    final _options = _setStreamType<BaseResponseDto<void>>(
      Options(method: 'PUT', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/shippers/${shipperId}/online-status',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
