...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,quoteId,idempotencyKey,restaurantId,deliveryAddress,deliveryLat,deliveryLng,customerName,customerPhone,paymentMethod,notes,const DeepCollectionEquality().hash(voucherIds),const DeepCollectionEquality().hash(items));

@override
String toString() {
  return 'CreateOrderRequestDto(quoteId: $quoteId, idempotencyKey: $idempotencyKey, restaurantId: $restaurantId, deliveryAddress: $deliveryAddress, deliveryLat: $deliveryLat, deliveryLng: $deliveryLng, customerName: $customerName, customerPhone: $customerPhone, paymentMethod: $paymentMethod, notes: $notes, voucherIds: $voucherIds, items: $items)';
}
...
@useResult
$Res call({
 String? quoteId,@JsonKey(includeFromJson: false, includeToJson: false) String? idempotencyKey, int restaurantId, String deliveryAddress, double deliveryLat, double deliveryLng, String customerName, String customerPhone, String paymentMethod, String? notes, List<int>? voucherIds, List<OrderItemRequest> items
});
...
/// Create a copy of CreateOrderRequestDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? quoteId = freezed,Object? idempotencyKey = freezed,Object? restaurantId = null,Object? deliveryAddress = null,Object? deliveryLat = null,Object? deliveryLng = null,Object? customerName = null,Object? customerPhone = null,Object? paymentMethod = null,Object? notes = freezed,Object? voucherIds = freezed,Object? items = null,}) {
  return _then(_self.copyWith(
...
switch (_that) {
case _CreateOrderRequestDto() when $default != null:
return $default(_that.quoteId,_that.idempotencyKey,_that.restaurantId,_that.deliveryAddress,_that.deliveryLat,_that.deliveryLng,_that.customerName,_that.customerPhone,_that.paymentMethod,_that.notes,_that.voucherIds,_that.items);case _:
  return orElse();
...
switch (_that) {
case _CreateOrderRequestDto():
return $default(_that.quoteId,_that.idempotencyKey,_that.restaurantId,_that.deliveryAddress,_that.deliveryLat,_that.deliveryLng,_that.customerName,_that.customerPhone,_that.paymentMethod,_that.notes,_that.voucherIds,_that.items);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,quoteId,idempotencyKey,restaurantId,deliveryAddress,deliveryLat,deliveryLng,customerName,customerPhone,paymentMethod,notes,const DeepCollectionEquality().hash(_voucherIds),const DeepCollectionEquality().hash(_items));
