...
enum DeliveryStatus {
  ...
  findingShipper('finding_shipper', 'Đang tìm shipper'),
  waitShipperConfirm('wait_shipper_confirm', 'Chờ shipper nhận đơn'),
  shipperNotFound('shipper_not_found', 'Không tìm được shipper'),
  ...
  bool get isDelivering =>
      this == DeliveryStatus.delivering || this == DeliveryStatus.pickedUp;
