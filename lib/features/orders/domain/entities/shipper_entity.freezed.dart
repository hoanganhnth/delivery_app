...
switch (_that) {
case _ShipperEntity():
return $default(_that.id,_that.name,_that.phone,_that.vehicleType,_that.vehicleNumber,_that.avatar,_that.rating,_that.totalTrips,_that.isOnline,_that.lastSeenAt,_that.createdAt,_that.updatedAt);}
}
