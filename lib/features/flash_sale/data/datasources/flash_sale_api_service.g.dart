...
part of 'flash_sale_api_service.dart';
...
class _FlashSaleApiService implements FlashSaleApiService {
  _FlashSaleApiService(this._dio, {this.baseUrl, this.errorLogger});
