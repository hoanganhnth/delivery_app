...
mixin _$MenuItemEntity {
  ...
  $MenuItemEntityCopyWith<MenuItemEntity> get copyWith =>
      _$MenuItemEntityCopyWithImpl<MenuItemEntity>(
          this as MenuItemEntity, _$identity);
...
abstract mixin class $MenuItemEntityCopyWith<$Res> {
  factory $MenuItemEntityCopyWith(
          MenuItemEntity value, $Res Function(MenuItemEntity) _then) =
...
extension MenuItemEntityPatterns on MenuItemEntity {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_MenuItemEntity value)? $default, {
...
class _MenuItemEntity implements MenuItemEntity {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$MenuItemEntityCopyWith<_MenuItemEntity> get copyWith =>
      __$MenuItemEntityCopyWithImpl<_MenuItemEntity>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _MenuItemEntity &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.restaurantId, restaurantId) ||
                other.restaurantId == restaurantId) &&
            (identical(other.name, name) || other.name == name) &&
...
/// @nodoc
abstract mixin class _$MenuItemEntityCopyWith<$Res>
    implements $MenuItemEntityCopyWith<$Res> {
  factory _$MenuItemEntityCopyWith(
          _MenuItemEntity value, $Res Function(_MenuItemEntity) _then) =
      __$MenuItemEntityCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? id,
