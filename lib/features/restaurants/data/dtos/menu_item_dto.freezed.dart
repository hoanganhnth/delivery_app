...
class _MenuItemDto implements MenuItemDto {
  const _MenuItemDto({this.id, this.restaurantId, required this.name, required this.description, required this.price, this.image, @MenuItemStatusConverter() required this.status});
