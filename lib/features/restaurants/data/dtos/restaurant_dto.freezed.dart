...
switch (_that) {
case _RestaurantDto():
return $default(_that.id,_that.name,_that.description,_that.address,_that.phone,_that.image,_that.closingHour,_that.openingHour,_that.addressLat,_that.addressLng);}
}
