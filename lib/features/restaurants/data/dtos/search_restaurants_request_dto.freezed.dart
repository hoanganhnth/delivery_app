...
mixin _$SearchRestaurantsRequestDto {
  ...
  $SearchRestaurantsRequestDtoCopyWith<SearchRestaurantsRequestDto>
      get copyWith => _$SearchRestaurantsRequestDtoCopyWithImpl<
              SearchRestaurantsRequestDto>(
          this as SearchRestaurantsRequestDto, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SearchRestaurantsRequestDto &&
  ...
  int get hashCode => Object.hash(
      runtimeType, query, latitude, longitude, category, page, limit);
...
abstract mixin class $SearchRestaurantsRequestDtoCopyWith<$Res> {
  factory $SearchRestaurantsRequestDtoCopyWith(
          SearchRestaurantsRequestDto value,
          $Res Function(SearchRestaurantsRequestDto) _then) =
      _$SearchRestaurantsRequestDtoCopyWithImpl;
  @useResult
  $Res call(
      {String query,
      double? latitude,
...
extension SearchRestaurantsRequestDtoPatterns on SearchRestaurantsRequestDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SearchRestaurantsRequestDto value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String query, double? latitude, double? longitude,
    ...
    switch (_that) {
      case _SearchRestaurantsRequestDto() when $default != null:
        return $default(_that.query, _that.latitude, _that.longitude,
            _that.category, _that.page, _that.limit);
      case _:
        return orElse();
    }
  }
...
class _SearchRestaurantsRequestDto implements SearchRestaurantsRequestDto {
  const _SearchRestaurantsRequestDto(
      {required this.query,
      this.latitude,
      this.longitude,
      this.category,
      this.page,
      this.limit});
  factory _SearchRestaurantsRequestDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SearchRestaurantsRequestDtoCopyWith<_SearchRestaurantsRequestDto>
      get copyWith => __$SearchRestaurantsRequestDtoCopyWithImpl<
          _SearchRestaurantsRequestDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SearchRestaurantsRequestDtoToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SearchRestaurantsRequestDto &&
            (identical(other.query, query) || other.query == query) &&
            (identical(other.latitude, latitude) ||
                other.latitude == latitude) &&
            (identical(other.longitude, longitude) ||
...
/// @nodoc
abstract mixin class _$SearchRestaurantsRequestDtoCopyWith<$Res>
    implements $SearchRestaurantsRequestDtoCopyWith<$Res> {
  factory _$SearchRestaurantsRequestDtoCopyWith(
          _SearchRestaurantsRequestDto value,
          $Res Function(_SearchRestaurantsRequestDto) _then) =
      __$SearchRestaurantsRequestDtoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String query,
