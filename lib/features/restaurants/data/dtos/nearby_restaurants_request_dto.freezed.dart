...
mixin _$NearbyRestaurantsRequestDto {
  ...
  $NearbyRestaurantsRequestDtoCopyWith<NearbyRestaurantsRequestDto>
      get copyWith => _$NearbyRestaurantsRequestDtoCopyWithImpl<
              NearbyRestaurantsRequestDto>(
          this as NearbyRestaurantsRequestDto, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NearbyRestaurantsRequestDto &&
...
abstract mixin class $NearbyRestaurantsRequestDtoCopyWith<$Res> {
  factory $NearbyRestaurantsRequestDtoCopyWith(
          NearbyRestaurantsRequestDto value,
          $Res Function(NearbyRestaurantsRequestDto) _then) =
      _$NearbyRestaurantsRequestDtoCopyWithImpl;
  @useResult
...
extension NearbyRestaurantsRequestDtoPatterns on NearbyRestaurantsRequestDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_NearbyRestaurantsRequestDto value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _NearbyRestaurantsRequestDto() when $default != null:
        return $default(_that.latitude, _that.longitude, _that.radius);
      case _:
        return orElse();
    }
  }
...
class _NearbyRestaurantsRequestDto implements NearbyRestaurantsRequestDto {
  const _NearbyRestaurantsRequestDto(
      {required this.latitude, required this.longitude, this.radius});
  factory _NearbyRestaurantsRequestDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NearbyRestaurantsRequestDtoCopyWith<_NearbyRestaurantsRequestDto>
      get copyWith => __$NearbyRestaurantsRequestDtoCopyWithImpl<
          _NearbyRestaurantsRequestDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NearbyRestaurantsRequestDtoToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _NearbyRestaurantsRequestDto &&
            (identical(other.latitude, latitude) ||
                other.latitude == latitude) &&
            (identical(other.longitude, longitude) ||
                other.longitude == longitude) &&
...
/// @nodoc
abstract mixin class _$NearbyRestaurantsRequestDtoCopyWith<$Res>
    implements $NearbyRestaurantsRequestDtoCopyWith<$Res> {
  factory _$NearbyRestaurantsRequestDtoCopyWith(
          _NearbyRestaurantsRequestDto value,
          $Res Function(_NearbyRestaurantsRequestDto) _then) =
      __$NearbyRestaurantsRequestDtoCopyWithImpl;
  @override
  @useResult
  $Res call({double latitude, double longitude, double? radius});
}
