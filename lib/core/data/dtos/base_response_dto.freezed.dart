...
mixin _$BaseResponseDto<T> {
  ...
  $BaseResponseDtoCopyWith<T, BaseResponseDto<T>> get copyWith =>
      _$BaseResponseDtoCopyWithImpl<T, BaseResponseDto<T>>(
          this as BaseResponseDto<T>, _$identity);
...
abstract mixin class $BaseResponseDtoCopyWith<T, $Res> {
  factory $BaseResponseDtoCopyWith(
          BaseResponseDto<T> value, $Res Function(BaseResponseDto<T>) _then) =
      _$BaseResponseDtoCopyWithImpl;
  @useResult
...
extension BaseResponseDtoPatterns<T> on BaseResponseDto<T> {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_BaseResponseDto<T> value)? $default, {
...
class _BaseResponseDto<T> implements BaseResponseDto<T> {
  const _BaseResponseDto(
      {required this.status, required this.message, this.data});
  factory _BaseResponseDto.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$BaseResponseDtoCopyWith<T, _BaseResponseDto<T>> get copyWith =>
      __$BaseResponseDtoCopyWithImpl<T, _BaseResponseDto<T>>(this, _$identity);
...
/// @nodoc
abstract mixin class _$BaseResponseDtoCopyWith<T, $Res>
    implements $BaseResponseDtoCopyWith<T, $Res> {
  factory _$BaseResponseDtoCopyWith(
          _BaseResponseDto<T> value, $Res Function(_BaseResponseDto<T>) _then) =
      __$BaseResponseDtoCopyWithImpl;
  @override
  @useResult
  $Res call({int status, String message, T? data});
}
