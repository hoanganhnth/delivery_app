  ...
  class ErrorInterceptor extends Interceptor {
    ...
    void onError(DioException err, ErrorInterceptorHandler handler) {
      ...
      if (err.response?.statusCode == 401 && onRefreshToken != null) {
        // Fire async operation without making method async
        _handleTokenRefresh().then((newAccessToken) async {
          if (newAccessToken != null && newAccessToken.isNotEmpty) {
            ...
            try {
              ...
              AppLogger.e("Failed to retry request after token refresh", retryError);
